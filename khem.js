...
`,s=()=>c>=f,u=()=>{for(;!s()&&o(m());)t()},l=()=>{t();let a=1,p=c;for(;!s();){let S=t();if(S==="{")a++;else if(S==="}"&&--a===0)break}return e.slice(p,c-1).trim()},d=()=>{t();let a=1,p=c;for(;!s();){let S=t();if(S==="[")a++;else if(S==="]"&&--a===0)break}return h(e.slice(p,c-1).trim())},i=()=>{t();let a="",p=!1;for(;!s()&&!(!p&&m()==='"');){let S=t();if(S==="\\"&&!p){p=!0;continue}if(p){if(p=!1,S==="n"){a+=`
`;continue}if(S==="t"){a+="	";continue}if(S==="$"){a+="";continue}}a+=S}return s()||t(),a},_=()=>{let a="";for(;!s();){let p=m();if(o(p)||n(p)||p==="#"||p==="["||p==="]"||p==="{"||p==="}"||p==='"')break;a+=t()}return a},y=()=>{let a=[];for(;!s()&&(u(),!s());){let p=m();if(n(p)||p==="#")break;p==="{"?a.push(l()):p==="["?a.push(d()):p==='"'?a.push(i()):a.push(_())}return a};for(;!s()&&(u(),!s());){let a=m();if(n(a)){t();continue}if(a==="#"){for(;!s()&&m()!==`
`;)t();continue}let p=y();p.length>0&&r.push(p)}return r}var w=(e=null)=>({vars:{},parent:e}),O=(e,r)=>{let c=e;for(;c;){if(r in c.vars)return String(c.vars[r]);c=c.parent}return null};function x(e,r){return typeof e!="string"?e:e.replace(/\$([a-zA-Z_][a-zA-Z0-9_-]*)/g,(c,f)=>O(r,f)??c).replace(/\x01/g,"$")}function $(e,r,c){let f=[],m=c.sub??x;for(let t of e){if(!Array.isArray(t)||t.length===0)continue;let o=typeof t[0]=="string"?t[0]:null;if(!o)continue;let n=c.cmds[o];if(!n){console.error(`Unknown command: ${o}`);continue}let u=t.slice(1).map(d=>Array.isArray(d)?$(d,r,c).join(""):m(d,r)),l=n(u,r);if(l?.__khemReturn)return[l.value??""];l!=null&&f.push(String(l))}return f}function C(e,r){return $(e,w(),r).join("")}var g=e=>e&&e!=="0"&&e!=="false",b=e=>Number(e)||0;function j(e){let r=e.cmds;r.text=t=>t[0]??"",r.set=(t,o)=>(o.vars[t[0]]=t[1]??"",null),r.puts=t=>(console.log(t.join(" ")),null),r.if=(t,o)=>{let[n,s,u,l]=t;return g(n)?$(h(s),o,e):u==="else"&&l?$(h(l),o,e):null},r.for=(t,o)=>{let[n,s,u,l]=t,d=[],i=h(l),_=o.vars[n];for(let y=b(s);y<=b(u);y++)o.vars[n]=String(y),d.push(...$(i,o,e));return _!==void 0?o.vars[n]=_:delete o.vars[n],d},r.foreach=(t,o)=>{let[n,s,u]=t,l=String(s).split(/\s+/).filter(Boolean),d=h(u),i=[],_=o.vars[n];for(let y of l)o.vars[n]=y,i.push(...$(d,o,e));return _!==void 0?o.vars[n]=_:delete o.vars[n],i},r.proc=t=>{let[o,n,s]=t,u=h(s),l=h(n).map(d=>typeof d=="string"?{name:d,default:null}:{name:d[0],default:d[1]??null});return r[o]=(d,i)=>{let _=w(i),y=0;for(let p of l){let S=y<d.length?d[y++]:p.default??"";_.vars[p.name]=S}let a=$(u,_,e);return a.length>0&&a[0]?.__khemReturn?[a[0].value??""]:a},null},r.return=t=>({__khemReturn:!0,value:t[0]??""}),r.list=t=>t.join(" "),r.llength=t=>t[0].split(/\s+/).filter(Boolean).length,r.lindex=t=>t[0].split(/\s+/).filter(Boolean)[b(t[1])]??"",r.lappend=(t,o)=>(o.vars[t[0]]=(o.vars[t[0]]||"")+" "+t.slice(1).join(" "),null),r.concat=t=>t.join(" "),r.join=t=>t.length===2&&t[0].includes(" ")?t[0].split(/\s+/).join(t[1]||" "):t.join(""),r.expr=(t,o)=>{let n=t.join(" ");n=n.replace(/==/g,"===").replace(/!=/g,"!==");try{return String(new Function("return "+n)())}catch{return"0"}},r.incr=(t,o)=>(o.vars[t[0]]=String(b(o.vars[t[0]]||0)+b(t[1]||1)),o.vars[t[0]]),r.abs=t=>String(Math.abs(b(t[0]))),r.round=t=>String(Math.round(b(t[0]))),r.floor=t=>String(Math.floor(b(t[0]))),r.ceil=t=>String(Math.ceil(b(t[0]))),r.sqrt=t=>String(Math.sqrt(b(t[0]))),r.max=t=>String(Math.max(...t.map(b))),r.min=t=>String(Math.min(...t.map(b))),r.string=t=>{let[o,n,...s]=t;switch(o){case"length":return String(n.length);case"index":return n[b(s[0])]||"";case"range":return n.slice(b(s[0]),s[1]?b(s[1])+1:void 0);case"trim":return n.trim();case"toupper":return n.toUpperCase();case"tolower":return n.toLowerCase();case"match":return new RegExp(s[0].replace(/\*/g,".*").replace(/\?/g,".")).test(n)?"1":"0";default:return""}},r.eq=t=>t[0]===t[1]?"1":"0",r.neq=t=>t[0]!==t[1]?"1":"0",r.gt=t=>b(t[0])>b(t[1])?"1":"0",r.lt=t=>b(t[0])<b(t[1])?"1":"0",r.gte=t=>b(t[0])>=b(t[1])?"1":"0",r.lte=t=>b(t[0])<=b(t[1])?"1":"0",r.not=t=>g(t[0])?"0":"1",r.and=t=>g(t[0])&&g(t[1])?"1":"0",r.or=t=>g(t[0])||g(t[1])?"1":"0",r.replace=t=>t[0].replaceAll(t[1],t[2]),r.trim=t=>t[0].trim(),r.upper=t=>t[0].toUpperCase(),r.lower=t=>t[0].toLowerCase(),r.slice=t=>t[0].slice(b(t[1]),t[2]?b(t[2]):void 0),r.contains=t=>t[0].includes(t[1])?"1":"0",r["starts-with"]=t=>t[0].startsWith(t[1])?"1":"0",r["ends-with"]=t=>t[0].endsWith(t[1])?"1":"0",r.today=()=>new Date().toISOString().slice(0,10),r.clock=t=>t[0]==="seconds"?String(Math.floor(Date.now()/1e3)):new Date().toLocaleString(),r.match=(t,o)=>{let n=t[0],s=[];if(t.length===2&&typeof t[1]=="string"){let l=t[1],d=[],i=0;for(;i<l.length;){for(;i<l.length&&/\s/.test(l[i]);)i++;if(i>=l.length)break;let _="";if(l[i]==='"'){for(i++;i<l.length&&l[i]!=='"';)_+=l[i],i++;i<l.length&&i++}else for(;i<l.length&&!/[\s{}]/.test(l[i]);)_+=l[i],i++;for(;i<l.length&&/\s/.test(l[i]);)i++;if(l[i]==="{"){i++;let y=1,a="";for(;i<l.length&&y>0&&(l[i]==="{"&&y++,!(l[i]==="}"&&(y--,y===0)));)a+=l[i],i++;i<l.length&&i++,d.push([_.trim(),a.trim()])}}s=d}else for(let l=1;l<t.length;l++)Array.isArray(t[l])&&t[l].length>=2&&s.push(t[l]);let u=null;for(let[l,d]of s){let i=h(d);if(l==="default"){u=i;continue}if(l===n)return $(i,o,e)}return u?$(u,o,e):null},r.try=(t,o)=>{try{return $(h(t[0]),o,e)}catch(n){let s=o.vars.error;if(t[1]==="catch"&&t[2])return o.vars.error=n.message,$(h(t[2]),o,e);throw s!==void 0?o.vars.error=s:delete o.vars.error,n}},r.throw=t=>{throw new Error(t[0])},r.dict=t=>{let[o,...n]=t;switch(o){case"create":{let s=[];for(let u=0;u<n.length;u+=2)s.push(n[u],n[u+1]||"");return s.join(" ")}case"get":{let s=n[0].split(/\s+/);for(let u=0;u<s.length;u+=2)if(s[u]===n[1])return s[u+1];return""}case"set":{let s=n[0]?n[0].split(/\s+/):[],u=n[1],l=n[2],d=!1;for(let i=0;i<s.length;i+=2)if(s[i]===u){s[i+1]=l,d=!0;break}return d||s.push(u,l),s.join(" ")}default:return""}};let c=null,f=null,m=()=>typeof process<"u"&&process.versions?.node!=null;m()&&Promise.all([import("node:fs").catch(()=>null),import("node:path").catch(()=>null)]).then(([t,o])=>{t&&(c=t.default??t),o&&(f=o.default??o)}),r.include=([t],o)=>{if(!t)return;if(!m()){console.warn(`include "${t}" skipped \u2014 browser`);return}if(!c||!f){console.error(`include "${t}" skipped \u2014 no fs`);return}let n=e._baseDir??process.cwd(),s=f.resolve(n,t);if(e._includes||(e._includes=new Set),e._includes.has(s))return;e._includes.add(s);let u=e._baseDir;try{e._baseDir=f.dirname(s);let l=c.readFileSync(s,"utf8");$(h(l),o,e)}catch(l){console.error(`include error: ${l.message}`)}finally{e._baseDir=u}}}function J(e,r){let c=m=>Array.isArray(m)?$(m,{vars:r.vars,parent:null},r).join(""):String(m),f=(m,t="")=>h(m).map(o=>{let n=o[o.length-1];return typeof n=="string"&&/[;\n]/.test(n)?`${t}${o.slice(0,-1).map(c).join(" ")} { 
${f(n,t+"  ")}${t}}`:`${t}${c(o[0])}: ${o.slice(1).map(c).join(" ")};`}).join(`
`)+`
`;return f(e)}function L(e,r){let c=[];for(let f of e){if(!Array.isArray(f)||f.length===0)continue;let m=f[0],t=f.slice(1);if(m==="set"){let o=typeof t[0]=="string"?t[0]:"";if(t[1]==="expr"&&typeof t[2]=="string"){let n=t[2].replace(/\$([a-zA-Z_][a-zA-Z0-9_-]*)/g,(s,u)=>`__s[${JSON.stringify(u)}]`);c.push(`__set(${JSON.stringify(o)}, (function(){try{return String(eval(${JSON.stringify(n)}))}catch{return "0"}})())`)}else{let n=t[1],s=typeof n=="string"?JSON.stringify(n):'""';c.push(`__set(${JSON.stringify(o)}, ${s})`)}}else{let o=t.map(n=>typeof n=="string"?JSON.stringify(n):'""');c.push(`__cmd(${JSON.stringify(m)}, ${o.join(", ")})`)}}return c.join("; ")}function A(e){let r=e.cmds,c={styles:[],bootScript:""};e._webCtx=c,e._state=e._state||{},e._stateRefs=e._stateRefs||new Set;let f=r.text;r.text=([t])=>{if(!t)return"";let o=e._state,n=t.replace(/\$([a-zA-Z_][a-zA-Z0-9_-]*)/g,(s,u)=>u in o?(e._stateRefs.add(u),`<span data-bind="${u}">${o[u]}</span>`):s);return n=n.replace(/\x01/g,"$"),n};let m=r.set;r.set=([t,o],n)=>t in e._state?(e._state[t]=o??"",e._stateRefs.add(t),null):m([t,o],n),r.elem=([t,o],n)=>{if(!t)return"";let s=typeof o=="string"?o:"",u=e._elemAttrs,l=e._elemEvents;e._elemAttrs={},e._elemEvents={};let d;try{let p=h(s);d=$(p,n,e).join("")}catch{d=s}let i={...e._elemAttrs},_={...e._elemEvents};e._elemAttrs=u,e._elemEvents=l;let y="";for(let[p,S]of Object.entries(i))y+=S?` ${p}="${S}"`:` ${p}`;for(let[p,S]of Object.entries(_))y+=` on${p}='${S}'`;return new Set(["br","hr","img","input","meta","link","area","base","col","embed","source","track","wbr"]).has(t)?`<${t}${y}>`:`<${t}${y}>${d}</${t}>`},r.a=([t,o],n)=>{let s=typeof o=="string"?o:"",u=e._elemAttrs,l=e._elemEvents;e._elemAttrs={href:t??"#"},e._elemEvents={};let d;try{d=$(h(s),n,e).join("")}catch{d=s}let i={...e._elemAttrs},_={...e._elemEvents};e._elemAttrs=u,e._elemEvents=l;let y="";for(let[a,p]of Object.entries(i))y+=p?` ${a}="${p}"`:` ${a}`;for(let[a,p]of Object.entries(_))y+=` on${a}='${p}'`;return`<a${y}>${d}</a>`},r.attr=([t,o])=>e._elemAttrs?(e._elemAttrs[t]=o??"",null):` ${t}="${o??""}"`,r.on=([t,o])=>{let s=L(h(typeof o=="string"?o:""),e);return e._elemEvents?(e._elemEvents[t]=s,null):` on${t}='${s}'`},r.state=([t,o])=>(t&&(e._state[t]=o??""),null),r.style=([t])=>(t&&c.styles.push(J(t,e)),null)}function E(e){let r=e._webCtx||{styles:[],bootScript:""},c=e._state||{},f=e._stateRefs||new Set,m=r.styles.join(`
...
</html>`}function v(e=!1){let r={cmds:{},vars:{}};return j(r),e&&A(r),r}function Y(e,r=v()){return $(h(e),{vars:r.vars,parent:null},r).join("")}function G(e,r){let c=v(!0);r&&(c._baseDir=r);let f=N();if(f){let t={vars:c.vars,parent:null};$(h(f),t,c)}let m={vars:c.vars,parent:null};return c._output=$(h(e),m,c).join(""),E(c)}function V(e){let r=v(!0),c=N();if(c){let f={vars:r.vars,parent:null};$(h(c),f,r)}return e.replace(/<script\s+type="text\/khem"[^>]*>([\s\S]*?)<\/script>/gi,(f,m)=>{try{let t={vars:r.vars,parent:null};return $(h(m.trim()),t,r).join("")}catch(t){return console.error("Khem script error:",t),`<!-- Error: ${t.message} -->`}})}var k=null;function N(){return k||(k=R,k)}var R=`proc div {body} { elem "div" "$body" }
...
proc on_keydown {body} { on "keydown" "$body" }`;export{v as createEnvironment,w as createScope,$ as evaluate,h as parse,V as processScriptTags,C as render,G as renderForWeb,Y as run,x as sub};
