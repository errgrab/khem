...
test("div: basic div", () => {
  const html = runForWeb(
    'page "home" { div "container" { text "Hello" } }\nroute "#/" "home"',
  );
...
test("p: paragraph", () => {
  const html = runForWeb(
    'page "home" { p "text" { text "Paragraph" } }\nroute "#/" "home"',
  );
...
test("button: with class", () => {
  const html = runForWeb(
    'page "home" { button "primary" { text "Submit" } }\nroute "#/" "home"',
  );
...
test("a: link", () => {
  const html = runForWeb(
    'page "home" { a "#/about" "link" { text "About" } }\nroute "#/" "home"',
  );
...
test("input: input element", () => {
  const html = runForWeb(
    'page "home" { input "" "" "placeholder=Enter" }\nroute "#/" "home"',
  );
