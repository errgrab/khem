export const createScope = parent => ({ vars: Object.create(parent.vars), cmds: parent.cmds, styles: parent.styles });

export const sub = (s, ctx) => typeof s === 'string' 
  ? s.replace(/\\\$|\$([a-zA-Z0-9_-]+)/g, (m, v) => m === '\\$' ? '$' : (ctx.vars[v] !== undefined ? ctx.vars[v] : m)) 
  : s;
